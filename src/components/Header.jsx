          ...
          <div className="hidden md:flex items-center gap-12">
            ...
            <nav className="flex items-center gap-10 text-[10px] font-semibold tracking-[0.15em] uppercase">
              {["Projects", "Expertise", "Insights"].map((item) => (
                ...
                >
                  <span className="text-white/60 font-light mr-5">+</span>{" "}
                  {item}
                </a>
              ))}
            </nav>
            ...
            <button
              ...
              className="border border-white/30 px-6 py-3 text-[10px] tracking-[0.15em] font-semibold hover:bg-white hover:text-black transition-all duration-300 uppercase"
            >
